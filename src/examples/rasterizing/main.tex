...
\section{Data Preparation and Adaptive Downsampling}
\label{sec:data}
...
\end{equation}
with amplitude defined from the total weight as
\begin{equation}
...
\begin{figure}[t]
  ...
  \subfloat[Screen-space weighted-merge approximation with merge threshold $\tau=\sigma$, reducing the representation to 275 kernels while preserving the dominant density structures, and integrating with only 1.67\% of error .]{%
