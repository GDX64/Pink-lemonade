//! The screen-space one-pass weighted merge --- the method this paper proposes.
//!
//! A single time-ordered scan groups consecutive samples whose weighted centre
//! stays within `merge_threshold` pixels of both the run's first sample and the
//! incoming one. O(N), no distance matrix, no per-pair search.

use wasm_bindgen::prelude::*;

use crate::common::{lower_bound_triplets, upper_bound_triplets, MergeResult};
